<footer id="page-footer">
	<div class="container text-center text-md-left">
		<div class="row">
			<div class="col-lg-4 col-md-5 mt-md-0 mt-3 mb-3">
				<img src="{{ URL::asset('img/logo-black.png') }}" class="regular-image-80" id="footer-logo">
			</div>
...
<div class="footer-black-bar">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-6">
				<a href="" class="footer-link">Attorney Advertising - Disclaimer</a>
			</div>
		</div>
	</div>
</div>